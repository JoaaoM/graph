...
public class Grafo<TIPO> {
    ...
    public ArrayList<Vertice<TIPO>> buscaEmLargura(TIPO inicio, TIPO fim) {
        ...
        HashMap<Vertice<TIPO>, Vertice<TIPO>> predecessores = new HashMap<>();
        ...
        while (!fila.isEmpty()) {
            ...
            if (verticeAtual == verticeFim) {
                // Reconstruir o caminho a partir dos predecessores
                Vertice<TIPO> vertice = verticeFim;
                while (vertice != null) {
            ...
            for (Aresta<TIPO> aresta : verticeAtual.getArestasSaida()) {
                Vertice<TIPO> proximoVertice = aresta.getFim();
